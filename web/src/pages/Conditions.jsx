  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--tx)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        <h1 style={{ fontSize: 28, fontWeight: 600, letterSpacing: '-.5px', marginBottom: 8 }}>Conditions d'utilisation</h1>
        ...
        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, marginBottom: 10 }}>4. Responsabilités</h2>
          <p style={{ fontSize: 13, lineHeight: 1.7, color: 'var(--t2)' }}>MEEREO met tout en é“uvre pour assurer la disponibilité et la fiabilité de la plateforme. Toutefois, MEEREO ne saurait être tenue responsable des interruptions, erreurs techniques ou pertes de données. L'utilisateur reste responsable de l'usage qu'il fait de la plateforme et des informations qu'il y publie.</p>
        </section>

        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 600, marginBottom: 10 }}>5. Propriété intellectuelle</h2>
