...
export default function TasksBoardPage({ showToast }) {
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <DSEmptyState icon="✅" title="Aucune tâche" description="Créez votre première tâche pour commencer à suivre l'avancement." actionLabel="Créer une tâche" onAction={() => setShowCreate(true)} />
      ) : view === 'board' ? (
        /* ═══ VUE BOARD ═══ */
