...
export default function MarchesPage({ showToast, onNavigate, openModal }) {
  ...
  return (
    <div>
      <DSPageHeader title="Marchés" subtitle={`${total} contrats · Pipeline des missions`}>
        ...
        <button className="btn btn-primary btn-sm" onClick={() => openModal('newMarche')}>+ Nouveau marché</button>
      </DSPageHeader>
