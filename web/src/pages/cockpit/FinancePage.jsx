...
const EXPENSE_CATEGORIES = ['Main d\'œuvre','Matériaux','Transport','Études','Honoraires','Équipements','Sous-traitance','Divers']
            ...
            <div>
              ...
              <div className="card" style={{ padding:'18px 22px', marginBottom:20 }}>
                ...
                <div style={{ display:'flex', justifyContent:'space-between', marginTop:6, fontSize:10, color:'var(--t4)' }}>
                  ...
                  <span style={{ color:'var(--err)' }}>🔴 90%</span>
                  <span>100%</span>
                </div>
              </div>
      ...
      <Modal isOpen={modal?.type === 'budget'} onClose={closeModal} title={modal?.mode === 'edit' ? 'Modifier le budget' : 'Nouveau budget'}
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
          <div>
            ...
            <input className="form-input" value={form.label || ''} onChange={e => pf('label', e.target.value)} placeholder="ex: Budget gros œuvre" />
          </div>
          <div>
