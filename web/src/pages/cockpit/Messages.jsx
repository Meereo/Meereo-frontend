    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', borderBottom: '1px solid var(--border)', flexShrink: 0 }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <span style={{ fontSize: 14, fontWeight: 600, letterSpacing: '-.2px', cursor: isPro && active.publicId ? 'pointer' : 'default' }} onClick={() => isPro && active.publicId && navigate(`/pro/${active.slug || active.publicId}`)}>{active.nom}</span>
