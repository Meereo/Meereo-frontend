...
export default function ProjetsPage({ onNavigate, openModal, showToast }) {
  ...
  return (
    <div>
      ...
      <DSPageHeader title="Projets" subtitle={showArchived ? archivedProjets.length + ' projet(s) archivé(s)' : activeProjets.length + ' projet(s) actif(s)'}>
        ...
        <NewProjectButton onOpen={() => openModal('newProjet')} context="header" />
      </DSPageHeader>
        ...
        <div className="split-right">
          {allProjets.length === 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', gap: 10 }}>
              ...
              <NewProjectButton onOpen={() => openModal('newProjet')} context="empty-state" style={{ marginTop: 4 }} />
            </div>
          ) : !selected ? (
