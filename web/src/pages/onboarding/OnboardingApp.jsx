...
export default function OnboardingApp() {
  ...
  const handleFinish = async (overrideDest) => {
    ...
    await createUser({email:email||'demo@meereo.ci', name:name || form.entreprise || 'Utilisateur', type:userType, ...fullData})
    ...
    // 4. Auto-AO removed — clients create AOs explicitly from their dashboard
    // (No implicit AO creation during onboarding)
