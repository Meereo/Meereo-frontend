...
export default function Client() {
  ...
  const PAGES = {
    ...
    ao: { label: "Appels d'offres", icon: <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 00-2-2h-4a2 2 0 00-2 2v16"/></svg>, group: 'Trouver' },
    ...
    /* SYS-01: Passeport Numérique RETIRÉ (v1.10) — entrée supprimée */
