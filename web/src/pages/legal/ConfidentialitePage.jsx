    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--tx)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        ...
        <section style={{ marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13, lineHeight: 1.7, color: 'var(--t2)' }}>MEEREO met en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre tout accès non autorisé, perte ou altération. Les données sont stockées sur des serveurs sécurisés. L'accès aux données est strictement limité au personnel autorisé.</p>
        </section>
