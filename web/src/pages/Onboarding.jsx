...
export default function Onboarding() {
  ...
  const { store, loginUser, createUser, showToast } = useMeereo()
  ...
  const handleFinish = async (overrideDest) => {
    ...
    showToast('Compte créé\u00a0! Connectez-vous pour accéder à votre espace.', 'green')

    // Redirect to login — user must explicitly log in after registration
