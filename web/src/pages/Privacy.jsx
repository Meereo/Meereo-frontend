  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', color: 'var(--tx)' }}>
      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '48px 24px 80px' }}>
        <h1 style={{ fontSize: 28, fontWeight: 800, letterSpacing: '-.5px', marginBottom: 8 }}>Politique de confidentialité</h1>
        <p style={{ fontSize: 12, color: 'var(--t3)', marginBottom: 32 }}>Dernière mise à jour : avril 2026</p>

        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 10 }}>1. Données collectées</h2>
        ...
        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 10 }}>2. Utilisation des données</h2>
        ...
        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 10 }}>3. Protection des données</h2>
          <p style={{ fontSize: 13, lineHeight: 1.7, color: 'var(--t2)' }}>MEEREO met en Å“uvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre tout accès non autorisé, perte ou altération. Les données sont stockées sur des serveurs sécurisés. L'accès aux données est strictement limité au personnel autorisé.</p>
        </section>

        <section style={{ marginBottom: 28 }}>
          <h2 style={{ fontSize: 16, fontWeight: 700, marginBottom: 10 }}>4. Partage des données</h2>
          <p style={{ fontSize: 13, lineHeight: 1.7, color: 'var(--t2)' }}>MEEREO ne vend pas vos données personnelles. Certaines informations peuvent Ãªtre partagées avec des prestataires techniques (hébergement, paiement) dans le strict cadre de la fourniture du service. Les informations de votre profil professionnel ou fournisseur sont visibles par les autres utilisateurs de la plateforme selon les paramètres de visibilité que vous définissez.</p>
        </section>
